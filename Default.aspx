...
<html>
  <head>
   ...
   <link href="/app.css" rel="stylesheet" />
    ...
    ></script>
    <script>
      const appId = 'sandbox-sq0idb-ye_j52BTSwJ5ezxXip20uQ';
      const locationId = 'LHVA87ER13V4N';
  ...
  <body>
    ...
    <input type="text" name="Phone" class="formStyle" placeholder="Phone# (required)" required />
    <input type="email" name="email_adress" class="formStyle" placeholder="Email (required)" required />
    <input type="text" name="amount_" class="formStyle" placeholder="Amount (required)" required />
      <h2>Pay $1.0 </h2>
